          ...
          <div className="landing overflow-hidden relative w-full h-screen bg-black">
            ...
            <div className="imagesdiv relative overflow-hidden w-full h-screen">
              ...
              <div className="text text-white flex flex-col gap-3 absolute top-20 left-1/2 -translate-x-1/2 scale-[1.4] rotate-[-10deg]">
                ...
                <h1 className="text-[10rem] leading-none ml-15">theft</h1>
          ...
          <div className="w-full h-screen flex items-center justify-center bg-black">
            <div className="cntnr flex text-white w-full h-[100%] ">
              ...
              <div className="rg w-[30%] py-20">
                ...
                <p className="mt-10 text scale-[1] font-[Helvetica_Now_Display]">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit.
                  Distinctio possimus, asperiores nam, omnis inventore nesciunt
                  a architecto eveniet saepe, ducimus necessitatibus at
                  voluptate.
                </p>
                <p className="mt-3 text font-[Helvetica_Now_Display]">
                ...
                <button className="bg-yellow-300 px-5 py-5 text-black mt-8 text-2xl">
                  Download Now
                </button>
              </div>
            </div>
